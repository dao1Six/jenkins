...
if __name__ == '__main__':
    jobList = ["七巧-前端/开发平台-在线编辑器IDE","七巧-后端/日志服务","七巧-后端/集成中心","七巧-后端/bpms-repository","七巧-后端/fdn-message","七巧-后端/fdn-authorize","七巧-后端/fdn-storage","七巧-后端/fdn-schema","七巧-后端/bpms-workbench","七巧-后端/bpms-operation", "七巧-后端/bpms-runtime","七巧-后端/bpms-portal","七巧-后端/bpms-appstore","七巧-前端/console","七巧-前端/m-runtime","七巧-前端/runtime","七巧-前端/operation","七巧-前端/help"]
    ...
    param_dict = {'Branch':'origin/release-1.3.1','PublishVersion':'true'}
